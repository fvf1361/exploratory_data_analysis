...
# 7- plotting a histogram into the png device
# 8- closing the png device


png(filename = "Plot1.png",  width = 480, height = 480, units = "px")
hist(data.sm$Global_active_power, col="red", main="Global active power (killowats)", xlab = "Global active power", ylab = "Frequency")
dev.off()
