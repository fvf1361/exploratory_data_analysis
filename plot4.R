...
# 7- plotting 2x2 matrix of plots into the png device
...
with(data.sm, plot(datetime, Voltage, type="l"))
with(data.sm, plot(datetime, Global_reactive_power, type="l", ylab = "Global reactive power"))
